...
const BlogDetailsArea = () => {
  ...
  return (
    <section id="blog-details" className="blog blog--details" ref={animateRef}>
      <div className="blog__container container">
        ...
        <div className="blog__content-area">
          ...
          <p className="blog__text">
            ...
            similique sunt in culpa qui mollitia animi, id est laborum et
            dolorum fuga. Et harum quidem rerum facilis est et expedita nam
            libero tempore, cum est eligendi optio cumque nihil impedit quo
            minus id quod
          </p>
        ...
        <div className="blog__content-area">
          ...
          <blockquote className="blog__quote">
            <p className="blog__quote-text">
              ...
              veniam, ullam corporis suscipit laboriosam, nisi ut aliquid ex ea
              commodi consequatur
            </p>
          </blockquote>
          ...
          <h2 className="blog__subtitle">As have to Achieves Always People</h2>
        ...
        <div className="blog__content-area">
          ...
          <p className="blog__text">
            ...
            pursues and desires to obtain pain of itself because it is pain, but
            because occur in toil and pain can procure him some great pleasure.{" "}
          </p>
          ...
          <div className="blog__tags-share">
            ...
            <div className="blog__share-group">
              ...
              <div className="blog__share">
                <a
                  href="https://www.facebook.com/sharer/sharer.php?u=https://maxfix-react-template.netlify.app/blog/blog-details"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="blog__share-icon"
                >
                ...
                <a
                  href="https://twitter.com/intent/tweet?url=https://maxfix-react-template.netlify.app/blog/blog-details&text=Check%20out%20this%20blog!"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="blog__share-icon"
                >
                ...
                <a
                  href="https://www.linkedin.com/shareArticle?mini=true&url=https://maxfix-react-template.netlify.app/blog/blog-details&title=Check%20out%20this%20blog!"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="blog__share-icon"
                >
          ...
          <div className="blog__navigation">
            <a href="#blog-details" className="blog__nav blog__nav--prev">
            ...
            <a href="#blog-details" className="blog__nav blog__nav--next">
              Next Post
              <svg width="28" height="16" viewBox="0 0 28 16" fill="none">
                <path
