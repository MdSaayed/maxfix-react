const services_data2 = [
  {
    ...
    text:
      'We help brands express their voice with strategic storytelling, impactful visuals, and digital experiences that leave lasting impressions.',
    tags: ['Brand Strategy', 'Visual Identity', 'UX Research', 'Print Design'],
  },
  {
    tab: 'Development',
  ...
  },
  {
    ...
    text:
      'From content structure to seamless navigation, we develop wireframes and sitemaps that build clarity and enhance digital flow.',
    tags: ['Wireframing', 'Sitemaps', 'UX Flow', 'Page Layout'],
  },
  {
    tab: 'Design Support',
