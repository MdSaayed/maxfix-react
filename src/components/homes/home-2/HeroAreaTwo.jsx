...
const HeroAreaTwo = () => {
    ...
    return (
      <section className="hero hero--two">
        ...
        <div className="hero__container container">
          <div className="hero__title-wrap">
            <h1 className="hero__title">
              ...
              <span className="hero__title-text hero__title-text-small">Brands in the</span>
            </h1>
          ...
          <div className="hero__subtitle-wrap">
            <div className="hero__video-thumb">
              <img src="./assets/images/hero/hero-home2-video.png" alt="Play Video"/>
              <Link
        ...
        <div className="hero__container-custom container hero__bg-img" style={sectionBg}>
            <TrustHighlight/>
        </div>
