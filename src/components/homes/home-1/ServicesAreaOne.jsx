        ...
        <section className="services services--one">
            <div className="services__container container">
                ...
                <div className="services__title-wrap title-wrap__flex">
                    <Subtitle text='What We Offer' wrapperClass='services__subtitle-wrap' subtitleClass='services__subtitle' />
                ...
                <div className="services__list">
                    {services_data?.map((service, index) => <ServicesItemOne key={index} index={index} service={service} activeIndex={activeIndex} toggleItem={toggleItem} />)}
                </div>
