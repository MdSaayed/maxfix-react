        ...
        <div className="team__content-wrap container">
          ...
          <div className="team__text-group">
            <p className="team__desc">
              We turn bold ideas into reality with a passionate team that blends
              strategy, design, and tech to craft meaningful brand experiences
              that inspire action and drive lasting connections.
            </p>
